...
main(int argc, char *argv[])
{
    ...
    if (!CU_add_test(pSuite, "xqc_cid_test", xqc_test_cid)
        ...
        || !CU_add_test(pSuite, "xqc_test_pmtud_confirmed_paths_raise_conn", xqc_test_pmtud_confirmed_paths_raise_conn)
        ...
        || !CU_add_test(pSuite, "xqc_test_pmtud_external_report_lowers_path", xqc_test_pmtud_external_report_lowers_path)
        || !CU_add_test(pSuite, "xqc_test_pmtud_external_report_never_raises", xqc_test_pmtud_external_report_never_raises)
        || !CU_add_test(pSuite, "xqc_test_pmtud_external_report_clamped_and_validated", xqc_test_pmtud_external_report_clamped_and_validated)
        || !CU_add_test(pSuite, "xqc_test_pmtud_convergence_arms_raise_timer", xqc_test_pmtud_convergence_arms_raise_timer)
        || !CU_add_test(pSuite, "xqc_test_pmtud_raise_reopens_without_lowering_conn", xqc_test_pmtud_raise_reopens_without_lowering_conn)
        || !CU_add_test(pSuite, "xqc_test_pmtud_raise_skips_path_at_ceiling", xqc_test_pmtud_raise_skips_path_at_ceiling)
        ...
        || !CU_add_test(pSuite, "xqc_test_wlb_asym_pin_follows_weight_ratio", xqc_test_wlb_asym_pin_follows_weight_ratio)
        ...
        || !CU_add_test(pSuite, "xqc_test_wlb_pinned_traffic_consumes_deficit", xqc_test_wlb_pinned_traffic_consumes_deficit)
        || !CU_add_test(pSuite, "xqc_test_wlb_deficit_debt_is_bounded", xqc_test_wlb_deficit_debt_is_bounded)
        || !CU_add_test(pSuite, "xqc_test_wlb_debt_floor_preserves_imbalance", xqc_test_wlb_debt_floor_preserves_imbalance)
        || !CU_add_test(pSuite, "xqc_test_wlb_weights_refresh_off_the_round_boundary", xqc_test_wlb_weights_refresh_off_the_round_boundary)
