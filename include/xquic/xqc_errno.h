...
typedef enum {
    ...
    XQC_EMP_INVALID_MP_VERTION =
        657, /**< Multipath - the multipath version value is invalid */
    XQC_EMP_NO_AVAILABLE_CID_FOR_PATH =
        658, /**< Multipath - there's no available unused cid for this path */
 ...
 */
typedef enum {
    XQC_QPACK_DECODER_VARINT_ERROR =
        900,                       /**< qpack decode variable-length integer error */
    ...
    XQC_QPACK_SAVE_HEADERS_ERROR =
        907, /**< failed to save name-value to header structure */
